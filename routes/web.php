...
Route::middleware(['auth', 'userMiddleware'])->group(function () {
    Route::get('/dashboard', [DataController::class, 'showDashboard'])->name('dashboard');

    Route::resource('/items', DataController::class)->names([
        'index' => 'items.index',
        'create' => 'items.create',
        'store' => 'items.store',
        'show' => 'items.show',
    ...
    Route::get('/print-items', [PDFController::class, 'showPrintForm'])->name('items.printForm');
    Route::post('/print-items', [DataController::class, 'printPDF'])->name('items.items.print');
});
