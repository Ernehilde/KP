...
class AdminDataController extends Controller
{
    ...
    public function show(DataItems $dataItem): View
    {
        ...
        return view('admin.item_show', compact('dataItem', 'totalHargaAki', 'totalHargaKardus', 'totalHargabl14_17', 'totalHargabl12_13', 'totalHargaKrb', 'totalHargabd', 'totalHargabotol', 'totalHargaOli'));
    }
